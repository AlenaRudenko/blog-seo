  ...
  return (
    <article className="flex flex-col text-center gap-3">
      ...
      <p className="text-justify text-sm/7">
        This privacy policy ("policy") will help you understand how [company
        name] ("us", "we", "our") uses and protects the data you provide to us
        when you visit and use [blog URL] ("blog", "service"). We reserve the
      ...
      <section>
        <h3 className="font-medium">What User Data We Collect</h3>
        <p className="text-justify text-sm/7">
      ...
      <section>
        <h3 className="font-medium">Why We Collect Your Data</h3>
        <p className="text-justify text-sm/7">
      ...
      <section>
        <h3 className="font-medium">Safeguarding and Securing the Data</h3>
        <p className="text-justify text-sm/7">
          [company name] is committed to securing your data and keeping it
          confidential. [company name] has done all in its power to prevent data
      ...
      <section>
        <h3 className="font-medium">Our Cookie Policy</h3>
        <p className="text-justify text-sm/7">
          Our Cookie Policy Once you agree to allow our blog to use cookies, you
          also agree to use the data it collects regarding your online behavior
        ...
        <p className="text-justify text-sm/7">
          ...
          https://www.internetcookies.com, which contains comprehensive
          information on how to do this on a wide variety of browsers and
          devices.
        </p>
      </section>
      <section>
        <h3 className="font-medium">Links to Other Websites</h3>
        <p className="text-justify text-sm/7">
          Our blog contains links that lead to other websites. If you click on
          these links [company name] is not held responsible for your data and
      ...
      <section>
        ...
        <p className="text-justify text-sm/7">
          ...
          you are filling the forms on the blog, make sure to check if there is
          a box which you can leave unchecked, if you don't want to disclose
          ...
          more than happy to change this for you. [company name] will not lease,
